...
<div class="products container-fluid">
   <div class="card shadow mb-4">
      <div class="card-header py-3">
         <div class="row">
            <div class="col-sm-10">
               <h6 class="font-weight-bold text-primary">Data Produk Toko</h6>
            </div>
            <div class="col-sm-2">
         ...
         <div class="table-responsive">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
               ...
               <tbody>
                  <tr>
                     <td>
                        <p class="text-center">{{ $loop->iteration + $products->firstItem() - 1 }}</p>
                     </td>
                     <td>
                        <p>{{ $product->nama }}</p>
                     </td>
                     ...
                     <td>
                        <p>Rp. {{ $product->harga }}, 00</p>
                     </td>
                     <td> <img src="{{ $product->image_url }}" alt="" width="50px">
                     </td>
                     <td>
                        <div class="row">
                           <div class="col-md my-1">
                              <a href="{{ route('products.edit',$product->id) }}" data-toggle="modal"
                                 data-target="#editModal{{ $product->id }}" class="btn btn-warning btn-block">Edit</a>
                              @include('utilities.editmodal')
                           </div>
                           <div class="col-md my-1">
            ...
            <div class="container text-center">
               <h1 class="text-dark">Silakan tambahkan data</h1>
               <svg id="ffc6eb9a-0ec0-429c-85a8-ff38b44048bf" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                  width="896" height="747.97143" viewBox="0 0 896 747.97143">
                  <path
